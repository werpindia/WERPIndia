        ...
        <div class="form">
	        <form class="form-horizontal signin" method="post" action="login_submit.php">
		        <div class="form-wrap" style="position: relative;">
		            ...
		            <div class="form-group">
		  	            <div class="relative">
			  	            <input name="password" class="form-control" type="password" required="required" placeholder="Password" pattern=".{8,}">
			  	            <i class="fa fa-key"></i>
		  	            </div>
	        ...
	        <form class="form-horizontal signup" name="f1"  onsubmit="return matchpass()"  action="signup_script.php" method="post">
		        <div class="form-wrap" style="position: relative;">
		            ...
		            <div class="form-group">
		  	            <div class="relative">
			  	            <input id="myinput" class="form-control" name="password" type="password" required="true" pattern=".{8,}" placeholder="Password">
			  	            <i class="fa fa-key"></i>
		  	            </div>
		  	            <span class="pull-right"><small><a id="showhide" href="javascript:void(0)">show / hide</a></small></span>
		            </div> 
		            <div class="form-group">
		  	            <div class="relative">
			  	            <input id="myinput2" class="form-control"  name="password2" type="password" required="" pattern=".{8,}" placeholder="Retype your Password">
			  	            <i class="fa fa-key"></i>
		  	            </div>
		  	            <!--span class="pull-right"><small><a id="showhide2" href="javascript:void(0)">show / hide</a></small></span-->
		            </div>          	
		            <div class="login-btn">

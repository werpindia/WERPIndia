$(document).ready(function(){
    ...
    var $grid = $('.blogRow').imagesLoaded( function() {
    ...
    $("#navBar2Lower-menu").click(function(){
        $(".navList2:eq(1)").toggle(500);
    });
    $("#navBar2Upper-menu").click(function(){
        $(".navList2:eq(0)").toggle(500);
    });

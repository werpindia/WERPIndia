...
<html>
    <head>
        <title>Change Password | MyVoice4Women</title>
        ...
        <div class="container" style="margin-top:30px;margin-bottom:30px;">
            ...
            <form method="post" action="settings_script.php">
	            <div class="form-group">
		            ...
		            <input id="password" type="password" placeholder="Enter your old password" name="password" class="form-control" required="true">
		        </div>
		        <div class="form-group">
		            <label for="newpassword">New Password</label>
	                <input id="newpassword" type="password" placeholder="Enter new password" name="newpassword" class="form-control" required="true" pattern=".{8,}">
		        </div>
		        <div class="form-group">
		            <label for="rnewpassword">Re-Enter New Password</label>
	                <input id="rnewpassword" type="password" placeholder="Re-Enter new password" name="rnewpassword" class="form-control" required="true" pattern=".{8,}">
		        </div>

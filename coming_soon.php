...
<html>
    <head>
        <title>Coming soon | MyVoice4Women</title>
    ...
    <body>
        ...
        <div id="center" class="container item">
            <img src="main_images/coming-soon.jpg" width="250px" height="250px">
            <br/><br/>
            <p class="c">Under construction !</p>
            <ul>
                <li>We are getting the content ready for this page.</li>
            </ul>
            <br/>
        </div>
